...
{
  var errorString = "";
  var theName = "Gateway IP Address: ";
  var notUseDescript = " is a special IP address and cannot be used here.";
  var notValidDescript = " is not a valid IP address.";
  if(cur_lang!="1")
  {
  	theName = "Adresse IP de la passerelle: ";
	notUseDescript = " est une adresse IP spéciale et ne peut être utilisée.";
	notValidDescript = " n'est pas une adresse IP valide.";
  }
  ...
  if (IPvalue == "0.0.0.0")
  {
    errorString = theName + IPvalue+notUseDescript;
  }
  else
    if (IPvalue == "255.255.255.255")
    {
      ...
      if (ipArray == null)
      {
        errorString = theName + IPvalue+notValidDescript;
      }
      else
        for (i = 1; i < 5; i++)
        {
